...
class DeliteSetupFp(Screen):
	...
	<screen position="160,115" size="390,370" title="Black Hole Fast Plugin Setup">
		...
		<ePixmap pixmap="skin_default/buttons/green.png" position="115,320" size="140,40" alphatest="on" />
		<widget name="key_green" position="115,320" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
	</screen>"""
	
	def __init__(self, session):
		Screen.__init__(self, session)
		
		self["key_green"] = Label(_("Set Favourite"))
		self.list = []
		self["list"] = List(self.list)
		self.updateList2()
