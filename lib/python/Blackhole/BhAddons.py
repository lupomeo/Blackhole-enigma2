...
class Nab_ShowFeedFile(Screen):
	...
	<screen position="center,center" size="800,405" title="Black Hole E2 Package Details">
		...
		<ePixmap pixmap="skin_default/buttons/red.png" position="173,365" size="140,40" alphatest="on" />
		<widget name="key_red" position="173,365" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1" />
		<ePixmap pixmap="skin_default/buttons/green.png" position="486,365" size="140,40" alphatest="on" />
		<widget name="key_green" position="486,365" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1" />
	</screen>"""
...
class Bh_Feed_Settings2(Screen):
	...
	def __init__(self, session):
		...
		self["actions"] = ActionMap(["WizardActions", "ColorActions"],
		{
			...
			"red": self.remove_Pack,
			"green": self.install_Pack,
			"yellow": self.setuP
		})
