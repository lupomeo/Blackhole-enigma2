...
class Nab_EpgSearch(Screen):
	...
	def searchEvent(self,cmd):
		...
		self.myserv = self.epgcache.search(('IR',48,eEPGCache.PARTIAL_TITLE_SEARCH,cmd,1));
...
class Nab_EpgSearchLast(Screen):
	...
	<screen position="160,115" size="390,320" title="Black Hole Epg Search History">
		...
		<widget name="key_green" position="115,270" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
	</screen>"""
	...
	def __init__(self, session):
		...
		self["key_green"] = Label(_("Clear History"))
