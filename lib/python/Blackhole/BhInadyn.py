...
class DeliteInaSetup(Screen, ConfigListScreen):
	...
	<screen position="140,120" size="440,300" title="Black Hole E2 Inadyn Setup">
		...
		<ePixmap pixmap="skin_default/buttons/green.png" position="150,250" size="140,40" alphatest="on" />
		<widget name="key_green" position="150,250" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
	</screen>"""
