...
class DeliteEpgPanel(Screen):
	...
	<screen position="339,100" size="602,510" title="Black Hole E2 EPG Settings">
		...
		<widget name="lminactive" position="20,10" zPosition="1" pixmap="skin_default/icons/ninactive.png" size="32,32" alphatest="on"/>
		<widget name="lmactive" position="20,10" zPosition="2" pixmap="skin_default/icons/nactive.png" size="32,32" alphatest="on"/>
		<widget name="labm" position="60,10" size="300,30" font="Regular;20" valign="center" transparent="1"/>
	...
	def __init__(self, session):
		...
		self["lminactive"] = Pixmap()
		self["lmactive"] = Pixmap()
		self["labm"] = Label(_("Enable Mhw2 internal reader"))
...
#xmltv:   Nome, tipo-epg, channel-name, channel-ref, 0
	...
	def updatemyinfo(self):
		...
		if config.epg.sky.value == True:
			self["lsactive"].show()
		else:
			self["lsinactive"].show()
			
		if config.epg.mhw.value == True:
			self["lmactive"].show()
		else:
			self["lminactive"].show()
...
class DeliteEpgAddProvider(Screen, ConfigListScreen):
	...
	<screen position="center,center" size="800,340" title="Black Hole EpgPanel: Add External epg Server">
		...
		<ePixmap pixmap="skin_default/buttons/green.png" position="100,270" size="140,40" alphatest="on" />
		<widget name="key_green" position="100,270" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
		<ePixmap pixmap="skin_default/buttons/yellow.png" position="560,270" size="140,40" alphatest="on" />
		<widget name="key_yellow" position="560,270" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1"/>
	</screen>"""
...
class DeliteEpgGlobalSetup(Screen, ConfigListScreen):
	...
	<screen position="339,190" size="602,340" title="Black Hole E2 EPG Setup">
		...
		<ePixmap pixmap="skin_default/buttons/green.png" position="235,290" size="150,40" alphatest="on" />
		<widget name="key_green" position="235,290" zPosition="1" size="150,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
	</screen>"""
	...
	def updateList(self):
		...
		self.mhw2disabled = NoSave(ConfigYesNo(default=True))
		...
		self.deliteepgdisabled.value = config.epg.sky.value
		self.mhw2disabled.value = config.epg.mhw.value
		self.deliteepgeidisabled.value = config.epg.eit.value
		...
		mhw2disabled = getConfigListEntry(_("Enable Mhw2 internal reader"), self.mhw2disabled)
		self.list.append(mhw2disabled)
	...
	def saveMyosd(self):
		...
		config.epg.sky.value = self.deliteepgdisabled.value
		config.epg.sky.save()

		config.epg.mhw.value = self.mhw2disabled.value
		config.epg.mhw.save()

		config.epg.eit.value = self.deliteepgeidisabled.value
		config.epg.eit.save()
...
class DeliteExtdatProv(Screen):
	...
	<screen position="center,center" size="800,400" title="Black Hole E2 EPG Settings">
		...
		<ePixmap pixmap="skin_default/buttons/green.png" position="100,350" size="140,40" alphatest="on"/>
...
class DeliteEpgChannels(Screen, ConfigListScreen):
	...
	<screen position="339,190" size="602,340" title="Epg Channels Setup">
		...
		<ePixmap pixmap="skin_default/buttons/green.png" position="50,300" size="140,40" alphatest="on"/>
		<ePixmap pixmap="skin_default/buttons/yellow.png" position="400,300" size="140,40" alphatest="on"/>
		<widget name="key_green" position="50,300" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1"/>
		<widget name="key_yellow" position="420,300" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1"/>
	</screen>"""
	...
	def __init__(self, session, provider):
		...
		ConfigListScreen.__init__(self, self.list)
		self["key_green"] = Label(_("Save"))
		self["key_yellow"] = Label(_("Update List"))
		self["Linconn"] = Label(_("Wait please download in progress ..."))
		self["Linconn"].hide()
		
		self["actions"] = ActionMap(["WizardActions", "ColorActions"],
		{
			"green": self.saveMychans,
			"yellow": self.updateMychans,
			"back": self.close
