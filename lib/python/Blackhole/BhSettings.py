...
class DeliteSetupOSD2(Screen):
	...
	<screen position="339,190" size="602,340" title="Black Hole Osd Settings">
		...
		<widget name="key_green" position="235,290" zPosition="1" size="150,40" font="Regular;18" halign="center" valign="center" backgroundColor="#9f1313" transparent="1"/>
	</screen>"""
...
class DeliteSetupCronConf(Screen, ConfigListScreen):
	...
	def updateList(self):
		...
		if f:
			...
			predefinedlist.sort()
		mychoices = mychoices + predefinedlist
		self.cmdtime = NoSave(ConfigClock(default=0))
		self.default_command = NoSave(ConfigSelection(default = "None", choices = mychoices))
...
class DeliteDevicesPanel(Screen):
	...
	<screen position="240,100" size="800,560" title="Black Hole Devices Manager">
		...
		<ePixmap pixmap="skin_default/buttons/green.png" position="440,524" size="140,40" alphatest="on" />
		...
		<widget name="key_green" position="440,520" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#a08500" transparent="1" />
    	</screen>"""
...
class DeliteKernelModules(Screen, ConfigListScreen):
	...
	<screen position="240,190" size="800,340" title="Black Hole Extra Kernel Modules Setup">
		<widget name="config" position="10,20" size="780,280" scrollbarMode="showOnDemand" />
		<ePixmap pixmap="skin_default/buttons/green.png" position="200,293" size="140,40" alphatest="on" />
		<ePixmap pixmap="skin_default/buttons/yellow.png" position="440,293" size="140,40" alphatest="on" />
		<widget name="key_green" position="200,290" zPosition="1" size="140,40" font="Regular;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
...
class BhSpeedUp(Screen, ConfigListScreen):
	...
	def __init__(self, session, firstrun = False):
		...
		if machine != "vusolo" and not machine.endswith(("4k", "4kse")):
